<!-- Context: project-intelligence/notes | Priority: high | Version: 1.1 | Updated: 2026-07-14 -->
...
- **PromptForm.tsx** is 1,021 lines — the largest component in the project and a potential refactor target.
...
|---------|------|----------|
| Production deployment to Vercel | Complete Fase 5 (deployment + smoke tests) | Pending |
