<!-- Context: project-intelligence/lookup | Priority: low | Version: 1.0 | Updated: 2026-08-06 -->

# Lookup: Decision Archive (#1–#11)

> Archivo de decisiones históricas (2026-04 → 2026-07). Movido desde `decisions-log.md` en el harvest 2026-08-06 para mantener el log vivo <200 líneas. El log actual (vivo) contiene #12–#16. Alternatives tables en `decision-details.md`.
